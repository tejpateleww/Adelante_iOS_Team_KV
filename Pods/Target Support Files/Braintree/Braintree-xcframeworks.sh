...
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/PPRiskMagnes.xcframework" "Braintree/PayPalDataCollector" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/CardinalMobile.xcframework" "Braintree/ThreeDSecure" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"
