...
class Profile : Codable{
    ...
    init(fromDictionary dictionary: [String:Any]){
        activationCode = dictionary["activation_code"] as? String
        activationSelector = dictionary["activation_selector"] as? String
        ...
        forgottenPasswordCode = dictionary["forgotten_password_code"] as? String
        forgottenPasswordSelector = dictionary["forgotten_password_selector"] as? String
        forgottenPasswordTime = dictionary["forgotten_password_time"] as? String
        ...
        rememberCode = dictionary["remember_code"] as? String
