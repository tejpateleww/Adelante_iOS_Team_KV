...
class ShareDetailsMainOrder : NSObject, NSCoding{

    var address : String!
    var createdAt : String!
    var discount : String!
    var discountAmount : String!
    var item : [ShareDetailsItem]!
	...
	init(fromJson json: JSON!){
        ...
        item = [ShareDetailsItem]()
        let itemArray = json["item"].arrayValue
        for itemJson in itemArray{
            let value = ShareDetailsItem(fromJson: itemJson)
            item.append(value)
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
		...
		item = aDecoder.decodeObject(forKey: "item") as? [ShareDetailsItem]
