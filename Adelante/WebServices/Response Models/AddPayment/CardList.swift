...
class CardList : NSObject, NSCoding{
    ...
    var cardCvv : String!
        ...
        init(fromJson json: JSON!){
            ...
            cardCvv = json["card_cvv"].stringValue
        ...
        */
        ...
        {
            cardCvv = aDecoder.decodeObject(forKey: "card_cvv") as? String
        ...
        */
        ...
        {
            if cardCvv != nil{
                aCoder.encode(cardCvv, forKey: "card_cvv")
            }
            if cardHolderName != nil{
