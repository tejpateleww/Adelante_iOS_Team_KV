...
//        self.colRestaurantCatList.reloadData()
       // self.colRestaurantCatList.scrollToItem(at: selectedIndexPath, at: .top, animated: true)
    }
...
//        colRestaurantCatList.scrollToItem(at: self.selectedIndexPath, at: .top, animated: true)
//    }
//    
