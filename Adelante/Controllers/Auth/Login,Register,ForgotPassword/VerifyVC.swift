...
//        })
//    }
//    func webserviceForOtpLogin()
//    {
//        let login = reqModelLogin
//        Utilities.showHud()
//        WebServiceSubClass.otp_login(loginModel: login, completion: { (json, status, response) in
//            Utilities.hideHud()
//            if(status)
//            {
//                let otpModel = otpRecived.init(fromJson: json)
//                self.strOTP = otpModel.otp ?? ""
//                Utilities.displayAlert("", message: json["message"].string ?? "", completion: {_ in
//                    self.showToast(message: otpModel.otp, font: CustomFont.medium.returnFont(20))
//                }, otherTitles: nil)
//            } else {
...
//    }
//
//    func webserviceForOtpRegister()
//    {
//        let register = reqModelLogin
//        Utilities.showHud()
//        WebServiceSubClass.otp_login(loginModel: register, completion: { (json, status, response) in
//            Utilities.hideHud()
//            if(status)
//            {
//                let otpModel = otpRecived.init(fromJson: json)
...
//    }
//
//    func goToAvailabiityScreen() {
//        let controller = AppStoryboard.Auth.instance.instantiateViewController(withIdentifier: SelectAvailabilityViewController.storyboardID) as? SelectAvailabilityViewController ?? SelectAvailabilityViewController()
